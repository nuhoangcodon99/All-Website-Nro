...
?>
            ...
            <div class="card">
               ...
               <?php
                     ...
                     //echo"Tên: $filename - Loại: $extension<br> gốc $basename";
                    echo'<div class="col-md-4 mt-1">
                            <div class="card download-bg '. ($i == 0 ? "false" : "suggestion") .' ">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Tải game cho '.$extension.'</h5>
                                    <p class="card-text">Nhấn vào đây để tải '.$basename.'</p>
                                    <a class="btn btn-danger me-1 mt-1" href="Others/Upload/'.$basename.'">Tải Ngay</a>
                                </div>
                            </div>
                        </div>';
                }
