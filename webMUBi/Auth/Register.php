        ...
        <div class="card">
            <div class="card-body">
                <h1 class="h3 font-weight-normal text-center">Đăng ký</h1>
                    ...
                    <input type="text" class="form-control" placeholder="Tài khoản" required="" id="username" value=""
                        minlength="3">
                </div>
                <div class="form-group mb-2">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="password" class="form-control" placeholder="Xác nhận mật khẩu" required=""
                        id="RePasswordword" minlength="3">
                </div>

                <div class="form-group text-center">
                    <button onclick="Register('<?php echo$_SESSION['secret_key'];?>')" class="btn btn-info btn-block text-white" type="button">Đăng ký</button>
                </div>
