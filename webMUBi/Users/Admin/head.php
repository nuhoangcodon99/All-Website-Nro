...
<head>
	...
	<link href="'.until::domain("Users/Admin/vendor/jquery-nice-select/css/nice-select.css").'" rel="stylesheet">
	<link href="'.until::domain("Users/Admin/vendor/owl-carousel/owl.carousel.css").'" rel="stylesheet">
	<link rel="stylesheet" href="'.until::domain("Users/Admin/vendor/nouislider/nouislider.min.css").'">
	
	<!-- Style css -->
    <link href="'.until::domain("Users/Admin/css/style.css").'" rel="stylesheet">
								...
								<ul class="contacts">
									...
									<li class="active dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">																<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">				<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									<img src="'.until::avatar().'" width="56" alt="">
								</a>
								<div class="dropdown-menu dropdown-menu-end">
									...
									<a href="'.until::domain("trang-chu").'" class="dropdown-item ai-icon">
            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Shop(Items)</span>
						</a>
                        <ul aria-expanded="false">
							<li><a href="'.until::domain("ADMIN/ADD-ITEMS").'">Add Shop Item</a></li>
							<li><a href="'.until::domain("ADMIN/ITEMS").'">Quản Lý Items</a></li>
						</ul>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="'.until::domain("ADMIN/SETTING").'">Setting Web</a></li>	
                                </ul>
                            </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="'.until::domain("ADMIN/ACCOUNT").'">Tất Cả Tài Khoản</a></li>
                            <li><a href="'.until::domain("ADMIN/ADD_VND").'">Cộng Tiền Cho Tài Khoản</a></li>
                        </ul>
                    </li>
