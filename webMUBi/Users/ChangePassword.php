            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="password" id="newpassword_confirm"
                            placeholder="Xác nhận mật khẩu mới bạn muốn" minlength="3" required>
                    </div>

                    <div style="text-align: center">
                        <button onclick="ChangePassword('<?php echo$_SESSION['secret_key'];?>')" type="button" style="display: block; margin: 0 auto; border: 2px solid #8BC34A; background-color: #C5E1A5; color: #FFFFFF; padding: 5px 20px; font-size: 16px; border-radius: 5px; cursor: pointer;">ĐỔI MẬT KHẨU</button>
                    </div>
                </div>
            </div>
        </form>
