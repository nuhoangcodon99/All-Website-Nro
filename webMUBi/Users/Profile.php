            ...
            <div class="card">
                <div class="card-body">
                    <div class="row text-center justify-content-center row-cols-3 row-cols-lg-6 g-1 g-lg-1"
                        data-metatip="true">
                        <div class="col">
                            <a class="btn btn-sm btn-success w-100 fw-semibold active" href="Profile"
                                style="background-color: #198754;">Thông Tin</a>
                        </div>
                        <div class="col">
                            <a class="btn btn-sm btn-success w-100 fw-semibold active" href="History"
                                style="background-color: #198754;">Lịch
                                sử GD</a>
                        </div>
                        <div class="col">
                            <a class="btn btn-sm btn-success w-100 fw-semibold active" href="TRANS_ITEMS"
                                style="background-color: #198754;">Lịch
                                Mua Item</a>
                        </div>
                    </div>
                    <table class="table table-border">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><b  id="vnd" class="text-danger1"></b>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">Tổng Nạp</th>
                                <td><b id="tongnap" class="text-danger1"></b>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/ChangePassword" class="btn btn-outline-info">Đổi mật khẩu</a>
                                </td>
                            </tr>
                            <!-- <tr>
        ...
        <div class="modal-content">
            <div class="modal-body d-flex justify-content-center align-items-center">
                <div class="my-2 text-center">
                    <div><img alt="Logo" src="/Assets/Images/logo.png" class="logo" style="max-width: 200px;"></div>
                    <div class="mt-2">
...
<script>
    GetInfo("<?php echo$_SESSION['secret_key'];?>");
