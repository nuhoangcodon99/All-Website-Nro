...
?>
    ...
    .text-container {
        margin-left: 40px; /* Số lượng pixel bạn muốn dịch chữ sang phải */
    }
</style>
<div class="card">
    <div class="card-body">
            ...
            <div class="post-item d-flex align-items-center my-2 justify-content-between">
                <div class="post-image">
                    <img src="Assets/Images/mubiicon.gif" alt="hd">
                </div>
                <div class="ant-list-item-meta">
                <div class="text-container">
                        <a href="Bxh" style="color: #0d6efd; font-weight: 700 !important;">Bảng Xếp Hạng</a>
            ...
            <div class="post-item d-flex align-items-center my-2 justify-content-between">
                ...
                <div class="ant-list-item-meta">
                <div class="text-container">
                        <a href="SHOPS" style="color: #0d6efd; font-weight: 700 !important;">Cửa hàng vật phẩm</a>
    ...
    <div class="table-responsive">
        ...
        <div class="card-title h5" style="text-align: center;">
            <img src="Assets/Images/Top.png" alt="iconTop" style="display: inline-block; height: 2rem;">
            <h1 style="display: inline-block; font-size: 1.25rem; line-height: 1.75rem;">BẢNG XẾP HẠNG SỨC MẠNH</h1>
            <img src="Assets/Images/Top.png" alt="iconTop" style="display: inline-block; height: 2rem;">
        </div>
        <div class="manage-body">
            ...
            <table class="table table-bordered table-hover" style="margin-top: 5px">
                ...
                <tbody id="ListBxh" class="text-center">
               </tbody></table>
</div>
</div>
</div>
