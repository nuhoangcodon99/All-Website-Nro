      ...
      <div class="alert alert-warning" style="background-color: #FFCCCC;">
        ...
        <div class="col">
          <div class="text text-dark text-left mt-2">
            <h4 class="ml-2 text-left">Chi Tiết Cơ Chế Ngọc Rồng Vegito</h4>
          </div>
          <hr>
        </div>
        <div class="text text-dark p-2">
          ...
          <div class="">
            ...
            <p><b style="color:red">
                <div><b>• Ngọc Rồng Vegito đăng kí nhận ngay 200.000 VNĐ vào tài khoản</b></br>
                  <b>• 💥 NÔNG DÂN CŨNG PHẢI MẠNH - GIỚI THIỆU ĐỘI HÌNH CHUẨN CÀY CHAY</br>👉 Chính thức ra mắt:
                    28/07/2024
                    </br>🔥 NGỌC RỒNG Vegito - Tựa Game Chuẩn Dragon Ball </br> 👉 Hóng ever game và nhận C.o.ᴅ.ᴇ tại:
