    ...
    <main>
      ...
      <div class="alert alert-warning" style="background-color: #FFCCCC;">
        ...
        <div class="text-center mb-1">
          <small class=""><b>Thông báo update ngày ... tháng ... !! </b></small>
          <br>
          <br>
        </div>
        <div class="col">
        ...
        <div class="text text-dark p-2">
          ...
          <div class="">
            <b style="color:blue">Server ngọc rồng .... được update như sau : </b><br>
            <p><b style="color:red"> </b></p>
            <div><b style="color:red"><b> Theo dõi <a style="color:blue" class="alert-link"
                    href="Nhập link zalo" title=""> Zalo </a> và web : để nhận thông tin mới nhất.
            ...
            <br>
            <p><strong>1. test ngày ... tháng ... : !</strong></p>
            <p>• -&gt; 
            </p>
            <p><strong>2. Thêm đệ tử siêu Vip với chỉ số chi tiết : </strong></p>
            <p>• -&gt; 100% Sức đánh + 100% HP + 100% KI
            </p>
