      ...
      <div class="alert alert-warning" style="background-color: #FFCCCC;">
        ...
        <div class="col">
          <div class="text text-dark text-left mt-2">
            <h4 class="ml-2 text-left">Chi Tiết Cơ Chế Ngọc Rồng</h4>
          </div>
          <hr>
        </div>
        <div class="text text-dark p-2">
          ...
          <div class="">
            ...
            <p><b style="color:red">
                <div><b>• Ngọc Rồng đăng kí nhận ngay 1 phần quà vào tài khoản</b></br>
                  <b>• 💥 NÔNG DÂN CŨNG PHẢI MẠNH - GIỚI THIỆU ĐỘI HÌNH CHUẨN CÀY CHAY</br>👉 Chính thức ra mắt:
                    ../../2024
                    </br>🔥 NGỌC RỒNG - Tựa Game Chuẩn Dragon Ball </br> 👉 Hóng ever game và nhận C.o.ᴅ.ᴇ tại:
                    <a style="color:black" class="alert-link" href="Nhập link zalo"
                      title=""> Zalo </a></b>
                </div>
