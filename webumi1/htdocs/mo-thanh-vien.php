    ...
    <div class="container pt-5 pb-5">
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                ...
                if ($_status == '1') {
                    $_alert = '<div class="text-danger pb-2 font-weight-bold">Tài khoản của bạn đã được kích hoạt!<br> Giftcode : nroumi<br> Giftcode : mtvumi<br> Giftcode : umi777<br> Giftcode : umi888<br> Giftcode : umi999 </div>';
                }
                ...
                elseif (($_status == '0' || $_status == '-1') && $_coin >= 20000) {
                    ...
                    if ($stmt->execute() && $stmt->affected_rows > 0) {
                        $_alert = '<div class="text-danger pb-2 font-weight-bold">Kích hoạt tài khoản thành công. <br> Bây giờ bạn đã có thể đăng nhập vào game!<br> Giftcode : nroumi<br> Giftcode : mtvumi<br> Giftcode : umi777<br> Giftcode : umi888<br> Giftcode : umi999 </div>';
                        if ($_status == '-1') {
                            $_alert = '<div class="text-danger pb-2 font-weight-bold">Kích hoạt tài khoản thành công. <br> Bây giờ bạn đã có thể đăng nhập vào game!<br> Giftcode : nroumi<br> Giftcode : mtvumi<br> Giftcode : umi777<br> Giftcode : umi888<br> Giftcode : umi999</div>';
                        }
                    } else {
                ...
                <form id="form" method="POST">
                    <div> Thông tin mở thành viên:<br>- Mở thành viên với chỉ <strong>20k VNĐ</strong>. <img
                        ...
                        Xây dựng, ủng hộ ngocrongumi.online hoạt động. </div>
