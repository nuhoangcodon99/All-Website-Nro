...
<body>
            ...
            <div class="col">
			    <div class="box-stt">
                    <div style="width: 40px; float:left; margin-right: 5px;">
                        <img src="image/avatar15.png" style="width: 35px">
                    </div>
                    <div class="box-right">
                        <a href="bang-xep-hang" class="important"> Bảng Xếp Hạng Sức Mạnh<img src="image/hot.gif"></a>
                        <div class="box-name" style="font-size: 9px;"> bởi ChiChi </div>
                    </div>
                </div>
				<div class="box-stt">
                    <div style="width: 40px; float:left; margin-right: 5px;">
                        <img src="image/avatar16.png" style="width: 35px">
                    </div>
                    <div class="box-right">
                        <a href="nhiem-vu" class="important"> Bảng Xếp Hạng Nhiệm Vụ<img src="image/hot.gif"></a>
                        <div class="box-name" style="font-size: 9px;"> bởi Bumma </div>
                    </div>
                </div>
                <div class="box-stt">
                    <div style="width: 40px; float:left; margin-right: 5px;">
                        <img src="image/avatar18.png" style="width: 35px">
                    </div>
                    <div class="box-right">
                        <a href="top-nap" class="important"> Bảng Xếp Hạng Nạp <img src="image/hot.gif"></a>
                        <div class="box-name" style="font-size: 9px;"> bởi Poc </div>
                    </div>
                <?php
    ...
    <div class="container pb-2">
        <div class="row mt-3">
            <div class="col-5">
                <a class="btn btn-main btn-sm" href="dang-bai">Đăng bài mới</a>
            </div>
            <?php
