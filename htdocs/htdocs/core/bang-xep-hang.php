...
LIMIT 10;";
        ...
        <div class="container color-forum pt-2">
            <div class="row">
                <div class="col">
                    <h6 class="text-center">BẢNG XẾP HẠNG ĐIỂM TRUNG THU</h6>
                    <table class="table table-borderless text-center">
                        <tbody>
                            <tr>
                                <th>#</th>
        ...
        <div class="container color-forum pt-2">
            <div class="row">
                <div class="col">
                    <h6 class="text-center">BẢNG XẾP HẠNG ĐIỂM SỰ KIỆN HÈ</h6>
                    <table class="table table-borderless text-center">
                        <tbody>
                            <tr>
                                <th>#</th>
            ...
            <div class="row">
                <div class="col">
                    <h6 class="text-center">BẢNG XẾP HẠNG ĐIỂM GẤP THÚ NGỌC RỒNG</h6>
                    <table class="table table-borderless text-center">
                        <tbody>
                            <tr>
                                <th>#</th>
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT name, JSON_EXTRACT(point_gapthu, '$[0]') AS second_value FROM player ORDER BY CAST(JSON_EXTRACT(point_gapthu, '$[0]') AS UNSIGNED) DESC LIMIT 20;";
                            $stmt = $conn->prepare($query);
                            $stmt->execute();
...
<div style="line-height:15px;font-size:12px;padding-bottom:10px;padding-top:6px;text-align:center">
    ...
    <div>
        <h5>
            2024© Được vận hành bởi <a href="Nhập link zalo...">Ngọc Rồng Online </a>
        </h5>
    </div>
</div>
</body>
