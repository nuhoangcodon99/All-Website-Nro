...
$query = "SELECT p.name, p.gender, p.pet_power, p.data_point, p.data_task, a.username, a.active, a.mkc2, a.vnd, a.tongnap, a.gmail, a.gioithieu, a.tichdiem
          FROM player p
