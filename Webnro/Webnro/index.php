...
<!-- Modal -->
  ...
  <div class="p-1 mt-1 alert alert-danger" style="border-radius: 7px; box-shadow: 0px 0px 5px black;">
    ...
    <p>Ngọc rồng  là trò chơi trực tuyến đa nền tảng. Bạn có thể chơi được trên mọi nền tảng từ máy tính PC Windows, iPhone, các dòng máy chạy hệ điều hành Android, Windows Phone đến các cả bản Java chạy trên S40, S60 cũ của Nokia. Với chất lượng cao và tốc độ mượt mà trên các loại đường truyền mạng ADSL, 3G, GPRS.
</p>
    ...
    <p>- Ngọc rồng  sẽ xuất hiện 1 boss mới với tên gọi Broly ban đầu mới xuất hiện sẽ rất yếu. Nhưng khi đánh
...
<footer class="mt-1">
    ...
    <div class="text-center mt-1">
       ...
       <a href="https://zalo.me/g/ynpzgj678" target="_blank"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTH886KOFLRKGxx584-lLivtzYhSqWkR37hE6_see9VWg&s" style="max-width:100px" class="mt-1"></a>
   </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="">
        <div class="modal-header text-center" style="background-color:#6b056e;">
            <img src="/img/logo.png" style="display: block; max-width:350px; margin:auto;">
        </div>
        <div class="modal-body">
        	  <b style="padding: 2px;">
        	      <span style="color:red;"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>CHÚ Ý:</span> Hiện tại có rất nhiều bên <span style="color:red;">sử dụng và ăn cắp ý tưởng cũng như là hình ảnh game và website</span> của <span style="color:purple;">NRO</span>!<br>
